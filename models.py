...
def create_discriminator(img_shape, nf=64, n_hidden_layers=3, reuse=False, name='discriminator'):
	...
	pred = tf.keras.layers.Conv2D(1, 3, strides=(1,1), padding='same', activation='sigmoid')(x)
