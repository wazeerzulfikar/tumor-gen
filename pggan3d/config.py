...
# desc += '-preset-v2-1gpu'; num_gpus = 1; sched.minibatch_base = 4; sched.minibatch_dict = {4: 64, 8: 32, 16: 16, 32: 4, 64: 1, 128: 16, 256: 8, 512: 4}; sched.G_lrate_dict = {1024: 0.0015}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
...
# desc += '-preset-v2-4gpus'; num_gpus = 4; sched.minibatch_base = 16; sched.minibatch_dict = {4: 256, 8: 256, 16: 64, 32: 64, 64: 32, 128: 8}; sched.G_lrate_dict = {256: 0.0015, 512: 0.002, 1024: 0.003}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000
desc += '-preset-v2-8gpus'; num_gpus = 8; sched.minibatch_base = 32; sched.minibatch_dict = {4: 512, 8: 256, 16: 128, 32: 64, 64: 32, 128: 16}; sched.G_lrate_dict = {128: 0.0015, 256: 0.002, 512: 0.003, 1024: 0.003}; sched.D_lrate_dict = EasyDict(sched.G_lrate_dict); train.total_kimg = 12000


# train.resume_run_id='017'
# # # # # train.resume_snapshot='001460'
# # # # train.network_snapshot_ticks=1
# train.resume_kimg=3749
# sched.tick_kimg_dict={4: 100, 8:80, 16:60, 32:40, 64:20, 128:60, 256:40, 512:20, 1024:10}
# sched.minibatch_dict = {4: 64, 8: 32, 16: 32, 32: 8, 64: 8}
